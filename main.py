...
def main():
    ...
    connection = MongoClient('localhost', 27017, username='root', password='rootpassword')
    ...
    while True:
        ...
        if user_input.lower() == 'exit':
            break
        similar_courses = similarity.similarity_search(user_input, connection['course_db']['vectorized_courses'])
